...
def noc_eval(pred, model_id, split, opt):
    ...
    gt_template_novel= '%s/noc_coco/annotations/'%(opt.data_path) + 'captions_split_set_%s_val_%s_novel2014.json'
    gt_template_train= '%s/noc_coco/annotations/'%(opt.data_path) + 'captions_split_set_%s_val_%s_train2014.json' 
